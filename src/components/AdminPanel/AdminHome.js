...
const MODULES = [
  ...
  { key: 'forecasting',  label: 'Forecasting',         icon: '🏨', desc: 'Occupancy & demand forecasting',               live: true  },
  ...
  { key: 'settings',     label: 'Settings',            icon: '⚙️', desc: 'Visibility, permissions and app configuration', live: true  },
];
