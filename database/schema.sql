...
-- ============================================================
-- USERS (employees, front desk, admin)
-- ============================================================
...
CREATE INDEX idx_time_entries_open ON time_entries(user_id) WHERE clock_out_time IS NULL;

-- Approval requests for manual / edited time entries
...
CREATE TABLE shift_notes (
  ...
  body            TEXT NOT NULL,
  -- roles that can see this note (null = all roles)
