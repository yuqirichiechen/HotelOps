...
-- ── RESERVATION HISTORY ───────────────────────────────────────────────────────
-- Migration: database/migrations/025_sprint18_reservation_history.sql
-- Per-reservation row, upserted on every scrape. Survives snapshot
-- pruning so past guest data persists indefinitely.
